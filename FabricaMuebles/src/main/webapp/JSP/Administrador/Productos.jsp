...
<html lang="en">
                    ...
                    <div class="card-deck text-center card-produts mr-2 ml-2">
                        <div class="card mb-4 shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <c:if test="${mueble.cantidadExistente>0}">
                                    <a href="${pageContext.request.contextPath}/ControladorVenta?tarea=solicitarCompra&mueble=${mueble.nombre}"
                ...
                <form action="${pageContext.request.contextPath}/ControladorVenta?tarea=devolucion"
                    ...
                    <div class="card border-info mb-3" style="max-width: 18rem;">
                        ...
                        <div class="card-body text-info">
                            <label for="nit" class="form-control"><h5 class="card-title text-center">Ingrese su NIT:</h5></label> 
                            <input class="form-control text-center" type="text" placeholder="Nit de cliente" required name="nit">
                        </div>
    ...
    <jsp:include page="../Vendedor/solicitudCompra.jsp"></jsp:include>
